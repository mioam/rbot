...
git remote add lerobot git@github.com:huggingface/lerobot.git
GIT_LFS_SKIP_SMUDGE=1 git subtree add --prefix=third_party/lerobot060 lerobot v0.6.0 --squash